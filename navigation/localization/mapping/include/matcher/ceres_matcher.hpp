...
#ifndef MAPPING_MATCHER_CERES_MATCHER_HPP_
#define MAPPING_MATCHER_CERES_MATCHER_HPP_
...
#include "../../../localization/loam_livox/src/eigen_math.hpp"
// Point to Point ICP
...
struct ceres_icp_point2point {
  ...
  bool operator()(const T *_q, const T *_t, T *residual) const {
    ...
    Eigen::Quaternion<T> q_interpolate = q_incre;
    Eigen::Matrix<T, 3, 1> t_interpolate = t_incre;
  ...
  static ceres::CostFunction *Create(
      ...
      Eigen::Matrix<_T, 4, 1> q_s = Eigen::Matrix<_T, 4, 1>(1, 0, 0, 0),
      Eigen::Matrix<_T, 3, 1> t_s = Eigen::Matrix<_T, 3, 1>(0, 0, 0)) {
    return (new ceres::AutoDiffCostFunction<ceres_icp_point2point, 3, 4, 3>(
