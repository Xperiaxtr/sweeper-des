#ifndef MAPPING_MATCHER_MATCHER_HPP_
#define MAPPING_MATCHER_MATCHER_HPP_
...
class Matcher {
 ...
 public:
  Matcher(int icp_max_iterations);
  void ResetIncremtalParam();
  Eigen::Matrix<double, 3, 1> PclPointToEigen(CloudData::POINT &pt);
  void PointAssociateToMap(CloudData::POINT const *const pi, CloudData::POINT *const po);
  double GetCloudToMapMacth(const CloudData::CLOUD_PTR &laser_cloud_corner,
                          ...
                          const CloudData::CLOUD_PTR &laser_cloud_intensity,
                              const CloudData::CLOUD_PTR &laser_cloud_corner_map_,
    const CloudData::CLOUD_PTR &laser_cloud_surf_map_,
    const CloudData::CLOUD_PTR &laser_cloud_intensity_map_);
  ...
  void CopyMapToMacther(const CloudData::CLOUD_PTR &laser_cloud_corner_map,
