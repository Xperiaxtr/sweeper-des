...
class Byte {
 public:
  ...
  static std::string double_to_hex(const uint32_t value);
  /**
  ...
  //-- Get a one-byte signed integer
  int8_t get_byte_signed(const int32_t start_pos, const int32_t length) const;
